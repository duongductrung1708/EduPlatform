              ...
              <Box display="flex" alignItems="center" justifyContent="space-between">
                <Box>
                  <Typography
                    variant="h3"
                    fontWeight="bold"
                    sx={{ mb: 1, color: '#FFFFFF', textShadow: '0 2px 4px rgba(0,0,0,0.3)' }}
                  >
                    {stats.classrooms}
                  </Typography>
        ...
        >
          <Box display="flex" alignItems="center" gap={1}>
            ...
            <Typography
              variant="h6"
              fontWeight={600}
              sx={{ color: '#FFFFFF', textShadow: '0 1px 2px rgba(0,0,0,0.3)' }}
            >
              Hành động nhanh
            </Typography>
          </Box>
                    ...
                    <Box display="flex" alignItems="center" justifyContent="space-between">
                      <Box flex={1}>
                        ...
                        <Stack direction="row" spacing={1}>
                          <Chip
                            size="small"
                            label={`${Math.max(0, c.studentsCount || 0)} học sinh`}
